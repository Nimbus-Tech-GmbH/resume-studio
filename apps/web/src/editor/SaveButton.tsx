...
export function SaveButton() {
  ...
  const canSave = validation.every((issue) => issue.severity !== "error") && !saving
  ...
  return (
    <Button
      ...
      onClick={onClick}
    >
      {saving ? <Spinner data-icon="inline-start" /> : <Save data-icon="inline-start" data-title="Save changes" />}
    </Button>
  )
}
